...
void DS3231::write() {
  uint8_t buffer[8] = {DS3231_REG_SECOND,       utils::dec2bcd(second),
                       utils::dec2bcd(minute),  utils::dec2bcd(hour),
                       utils::dec2bcd(weekday), utils::dec2bcd(day),
                       utils::dec2bcd(month),   utils::dec2bcd(year)};
